...
export const fields = [
  {
    ...
    soil: { ph: 6.7, nitrogen: 85, phosphorus: 72, potassium: 88, organicMatter: 3.2 },
  ...
  },
  {
    ...
    cropAge: 44,
    growthStage: 'Tillering',
    soil: { ph: 6.2, nitrogen: 68, phosphorus: 55, potassium: 78, organicMatter: 2.8 },
    irrigation: { status: 'needs-irrigation', lastIrrigated: '5 days ago', nextIrrigation: 'Tomorrow' },
  ...
  },
  {
    ...
    cropId: 'rice-c',
    area: 2.2,
    expectedRevenue: 213000,
    estimatedCost: 42000,
    expectedProfit: 171000,
    status: 'on-track',
    cropAge: 55,
    growthStage: 'Vegetative',
    soil: { ph: 6.5, nitrogen: 82, phosphorus: 67, potassium: 91, organicMatter: 3.5 },
  ...
  },
  {
    ...
    estimatedCost: 31000,
    expectedProfit: 114000,
    status: 'on-track',
    cropAge: 38,
    growthStage: 'Vegetative',
    soil: { ph: 6.5, nitrogen: 79, phosphorus: 74, potassium: 85, organicMatter: 3.0 },
...
export const diseaseData = [
  ...
  },
  {
    ...
    detected: '5 days ago',
    treatmentCost: '₹850',
    productionImpact: '-5% yield if untreated',
  },
];
...
export const analyticsData = {
  metrics: [
    { label: 'Expected Yield', value: 12.8, unit: 'Ton', change: 14, trend: 'up' },
    { label: 'Production Cost', value: 48250, unit: '₹', change: -5, trend: 'down' },
    { label: 'Revenue Forecast', value: 142000, unit: '₹', change: 12, trend: 'up' },
    { label: 'Expected Profit', value: 93750, unit: '₹', change: 21, trend: 'up' },
  ],
  productionTrend: [
    { day: '1', production: 11.2 },
    { day: '2', production: 11.5 },
    { day: '3', production: 11.4 },
    { day: '4', production: 11.8 },
    { day: '5', production: 12.1 },
    { day: '6', production: 12.5 },
    { day: '7', production: 12.8 },
  ],
  yieldTrend: [
  ...
  costTrend: [
    { week: 'W1', cost: 12500, budget: 14000 },
    { week: 'W2', cost: 11200, budget: 14000 },
    { week: 'W3', cost: 13800, budget: 14000 },
    { week: 'W4', cost: 10750, budget: 14000 },
  ],
};
...
export const recommendations = [
  {
    ...
    description: 'Expected yield in Field B has decreased by 8% due to delayed tillering.',
    impact: 'high',
    benefit: 'Adjust nutrition to recover yield',
    field: 'Field B',
    priority: 1,
    icon: 'trending-down',
  },
  {
    ...
    description: 'Leaf Blast detected in Field B. Treatment required immediately.',
    impact: 'high',
  ...
  },
  {
    ...
    description: 'Field A requires Urea application within 2 days for optimal tillering.',
    impact: 'medium',
    benefit: 'Improves expected yield by 0.2 Ton',
    field: 'Field A',
    priority: 2,
    icon: 'flask-conical',
  },
  {
    ...
    description: 'Basmati prices increased by 5%. Consider forward contracting Field C harvest.',
    impact: 'high',
    benefit: 'Locks in higher profit margin',
    field: 'Field C',
    priority: 3,
    icon: 'trending-up',
  },
  {
    ...
    description: 'Local mandi prices for DAP fertilizer dropped by 3%. Good time to stock up.',
    impact: 'medium',
    benefit: 'Reduces production cost by ₹1,200',
    field: 'All Fields',
    priority: 4,
    icon: 'activity',
  },
