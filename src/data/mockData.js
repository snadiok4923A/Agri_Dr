...
export const fields = [
  ...
  },
  {
    ...
    soil: { ph: 5.8, nitrogen: 82, phosphorus: 67, potassium: 91, organicMatter: 3.5, moisture: 68 },
...
export const crops = [
  ...
  },
  {
    ...
    timeline: [
      ...
      { stage: 'Flowering', completed: false },
      { stage: 'Tuber Formation', completed: false },
      { stage: 'Harvest', completed: false },
    ],
...
export const soilData = {
  ...
  fields: {
    ...
    'field-c': { ph: 5.8, nitrogen: 82, phosphorus: 67, potassium: 91, organicMatter: 3.5, moisture: 68 },
...
export const fertilizerData = {
  nextApplications: [
    { field: 'Field A', crop: 'Rice', product: 'Urea', amount: '40 kg', due: 'Tomorrow', priority: 'high' },
    { field: 'Field B', crop: 'Rice', product: 'DAP', amount: '25 kg', due: 'In 3 days', priority: 'high' },
    { field: 'Field C', crop: 'Potato', product: 'Potash', amount: '20 kg', due: 'In 5 days', priority: 'medium' },
  ],
  history: [
...
export const marketData = {
  crops: [
    ...
    },
    {
      ...
      trend: 'down',
      markets: [
        { name: 'Local Mandi', price: 1850 },
        { name: 'State Market', price: 1920 },
        { name: 'Regional APMC', price: 1780 },
      ],
      priceHistory: [
        { month: 'Apr', price: 2100 },
        { month: 'May', price: 2050 },
        { month: 'Jun', price: 1980 },
        { month: 'Jul', price: 1920 },
        { month: 'Aug', price: 1880 },
...
export const recommendations = [
  ...
  },
  {
    ...
    description: 'Consider optimizing nitrogen levels in Field C for better tuber development.',
    impact: 'low',
...
export const calendarData = [
  ...
  { date: 'Oct 15', task: 'Harvest', field: 'Field C', status: 'upcoming', type: 'harvest' },
];
